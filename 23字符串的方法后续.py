...
a = ("hello", "world", 1, 2, 3, (1, 2, 3), 5, 5, (1, 2, 3))
# 这是元组，不是字符串.
print(a.count((1, 2, 3)))
print(a.count(5))
...
b = ("hello", "world", 123, (1, 2, 3), 5, 5, (1, 2, 3))
# 仍然是元组。元组最厉害的就是以逗号做结构，不需要括号
...
c = "hello"
print(c.find("world"))
# find方法的作用：字符串中查找指定「子串」第一次出现的起始索引（下标）；如果找不到该子串，返回 -1。
print(c.find("hello"))
print(c.find("l"))
...
# 先给参数table创建规则：用1234567来代替ABCDEFG
