...
myfunc('python', 2)  # 传入参数'python',并设置参数times为2
...
print(div(9, 3))  # 传入的是非0的除数，所以if y ==0不成立，直接return x/y,即没有else语句也成立。
...
print(myfunc())  # 函数myfunc()执行完毕，没有显示返回值，所以返回None
# ---->None
"""
函数就像一台机器：
